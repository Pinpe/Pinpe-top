...
export const siteConfig: SiteConfig = {
  ...
  themeColor: {
    hue: 130,         // 主题色的默认色调值（0-360）。fixed 关掉时用不到（色相跟着天走）
    fixed: true,      // 对访客隐藏主题色选择器；打开时色相统一由 daylight-hue 决定
  },
  banner: {
    enable: true,    // 是否启用横幅
    text: '', //横幅标题
    ...
    credit: {
      enable: false,         // 是否显示横幅图片来源信息
      text: '星星坠落的傍晚',              // 显示的来源文本
      url: 'https://www.pixiv.net/artworks/68686407'                // （可选）原作品或艺术家页面的链接
    }
  },
  toc: {
