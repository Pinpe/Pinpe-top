...
export const siteConfig: SiteConfig = {
  ...
  themeColor: {
    hue: 60,         // 主题色的默认色调值（0-360）。例如：红色:0, 蓝绿色:200, 青色:250, 粉色:345
    fixed: false,     // 对访客隐藏主题色选择器
  },
  banner: {
    enable: true,    // 是否启用横幅
    text: '翠柏凝烟深似海，丹枫焕彩灿如霞', //横幅标题
    ...
    credit: {
      ...
      text: 'Luca Bravo',              // 显示的来源文本
      url: 'https://unsplash.com/photos/aerial-view-photography-of-forest-A-fubu9QJxE'                // （可选）原作品或艺术家页面的链接
    }
  },
  toc: {
