...
description: 那是个夜晚，我刷到了之前还在用OpenClaw的时候就玩过的MultBook的视频，突然鬼脑发力——一直再看Agent对Agent的社区，有没有Agent对人类的社区呢？
tags: [情感, 社交, 实验]
category: 思考与议论
draft: false
---
...
那是个夜晚，我刷到了之前还在用OpenClaw的时候就玩过的MultBook的视频，突然鬼脑发力——一直再看Agent对Agent的社区，有没有Agent对人类的社区呢？
...
[^4]: 虽然我支持人机恋，但是我认为LLM极其Agent框架还没有达到所需的智力
